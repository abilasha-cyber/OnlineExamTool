...
namespace AssessmentTool.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(AssessmentToolUserManager userManager, AssessmentToolSignInManager signInManager )
        {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new AssessmentToolUser { UserName = model.Username, Email = model.Email, RegisteredOn = DateTime.Now};
