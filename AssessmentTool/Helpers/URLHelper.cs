...
namespace AssessmentTool.Helpers
{
    public static class URLHelper
    {
        ...
        public static string CPNewUser(this UrlHelper helper)
        {
            string routeURL = string.Empty;

            routeURL = helper.RouteUrl("NewUser", new
            {
                controller = "ControlPanel",
                action = "NewUser"
            });
        ...
        public static string CPCandidateRegistraion(this UrlHelper helper, string searchTerm = "", int? pageNo = 1, int? pageSize = 10)
        {
            string routeURL = string.Empty;

            routeURL = helper.RouteUrl("CPCandidateRegistraion", new
            {
                controller = "ControlPanel",
                action = "CandidateRegistraion",
                search = searchTerm,
                page = pageNo.Value,
                items = pageSize.Value
            });
